# Convert .pb to .rt (tensorflow_tensorrt) and also save the graph in .pb format

from tensorflow.python.platform import gfile
import tensorflow as tf
from tensorflow.contrib import tensorrt as trt

graph_filename ='Alexnet_May_7.pb'
...
graph_filename_converted = 'flow_RT_frozen_tensorrt.pb'
